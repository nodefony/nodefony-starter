...
nodefony.registerCommand("router",function(){
	...
	var router = function(container, command, options ){
	...
	router.prototype.getRoutes = function(name, display){
	...
	router.prototype.displayTable = function(titre, ele){
	...
	router.prototype.matchRoutes = function(Url){
