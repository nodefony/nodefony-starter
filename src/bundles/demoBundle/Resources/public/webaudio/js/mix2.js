stage.register('mix2', function(){
	...
	var mixerUi = function(container){
		this.container = container;
		this.buildStruct();
	};
	
	mixerUi.prototype.buildStruct = function(){
	...
	mixerUi.prototype.addTrack = function(track, name, container){
	...
	mix.prototype.build = function(container){
	...
	mix.prototype.addTrack = function(name, media){
	...
	mix.prototype.buildDtmf = function(){
		var obj = {};
	...
	mix.prototype.build440 = function(){
		// LA 440
	...
	mix.prototype.playRinging = function( timeBlink, time){
		this.LA.play(0);
		if ( timeBlink ) {
			var blink = timeBlink;
		}else{
	...
	mix.prototype.playDtmf = function(key, duration){
		var touch = key+""
	...
	mix.prototype.playRing = function( duration){
